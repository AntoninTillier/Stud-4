...
public class MapReduceQ7 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TableMapReduceUtil.initTableMapperJob("21602559:G", scan1, Mapper7.class, Text.class, FloatWritable.class, job);
        job.setReducerClass(Reducer_Avg.class);
        job.setNumReduceTasks(1);
        FileOutputFormat.setOutputPath(job, new Path("/home/hadoop/Workspace/RestServer/Results/resuQ7"));

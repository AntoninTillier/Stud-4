...
public class MapReduceQ3 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(MapReduceQ3.class);
        ...
        FileOutputFormat.setOutputPath(job, new Path("/home/hadoop/Workspace/RestServer/Results/resuQ3"));
